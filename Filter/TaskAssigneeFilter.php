        ...
        if (is_int($this->value) || ctype_digit($this->value)) {
            ...
            switch ($this->value) {
                ...
                default:
                    ...
                    $this->query->addCondition(TaskModel::TABLE.".owner_gp IN (SELECT group_id FROM ".GroupMemberModel::TABLE." WHERE ".GroupMemberModel::TABLE.".user_id='$this->userModel->getIdByUsername($this->value)')");
                    $this->query->addCondition(TaskModel::TABLE.".owner_ms IN (SELECT group_id FROM ".MultiselectMemberModel::TABLE." WHERE ".MultiselectMemberModel::TABLE.".user_id='$this->userModel->getIdByUsername($this->value)')");
                    $this->query->closeOr();
            }
        }
    }
