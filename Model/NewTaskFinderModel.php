...
class NewTaskFinderModel extends Base
{
    ...
    public function getUserQuery($user_id)
    {
        return $this->getExtendedQuery()
                    ...
                    ->inSubquery(TaskModel::TABLE.'.owner_gp', $this->db->table(GroupMemberModel::TABLE)->columns('group_id')->eq('user_id', $user_id))
                    ->inSubquery(TaskModel::TABLE.'.owner_ms', $this->db->table(MultiselectMemberModel::TABLE)->columns('group_id')->eq('user_id', $user_id))
                    ->closeOr()
