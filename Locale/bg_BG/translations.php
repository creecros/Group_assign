...
return array(
    ...
    'Send email notification of impending due date to assigned group members' => 'Изпращане на имейл известие за наближаващ краен срок до възложените членове на групата',
    ...
    'Enter one line per task, or leave blank to copy Task Title and create only one subtask.' => 'Въведете по един ред за задача или оставете празно, за да копирате заглавието на задачата и да създадете само една подзадача.',
    'Event' => 'Събитие',
    ...
    'New due date: %s' => 'Нов краен срок: %s',
    'New group assigned: %s' => 'Нова възложена група: %s',
    ...
    'Start date changed: %s' => 'Началната дата е променена: %s',
    'Swimlane' => 'Коридор',
    'Tags' => 'Тагове',
    ...
    'The task is not assigned to multiple users anymore' => 'Задачата вече не е възложена на няколко потребители',
    'The task has been assigned to other users' => 'Задачата е възложена на други потребители',
    ...
    '[DUPLICATE]' => '[ДУБЛИКАТ]',
    'Enable group management for application managers' => 'Активиране на управление на групи за мениджъри на приложението',
    'Disable group management for application managers' => 'Деактивиране на управление на групи за мениджъри на приложението',
    'Add group assignment to tasks' => 'Добавяне на групово възлагане към задачите',
    'Group filters' => 'Групови филтри',
    'Include task title and ID in the subject line?' => 'Да се включат ли заглавието и ID на задачата в темата?',
);
