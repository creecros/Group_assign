...
return array(
    ...
    'Send email notification of impending due date to assigned group members' => 'Надіслати сповіщення електронною поштою про наближення терміну виконання призначеним членам групи',
    ...
    'New due date: %s' => 'Новий термін виконання: %s',
    ...
    'Start date changed: %s' => 'Дата початку змінена: %s',
    'Swimlane' => 'Доріжка',
    'Tags' => 'Мітки',
    ...
    'The field "%s" has been updated' => 'Поле "%s" оновлено',
    'The task is not assigned anymore' => 'Завдання більше не ставиться',
    'The task is not assigned to a group anymore' => 'Завдання більше не призначене групі',
    'The task is not assigned to multiple users anymore' => 'Завдання більше не призначене кільком користувачам',
    'The task has been assigned to other users' => 'Завдання призначено іншим користувачам',
    ...
    '[DUPLICATE]' => '[ДУБЛІКАТ]',
    'Enable group management for application managers' => 'Увімкнути керування групами для менеджерів застосунку',
    'Disable group management for application managers' => 'Вимкнути керування групами для менеджерів застосунку',
    'Add group assignment to tasks' => 'Додати групове призначення до завдань',
    'Group filters' => 'Фільтри груп',
    'Include task title and ID in the subject line?' => 'Додати назву та ID завдання до теми листа?',
);
